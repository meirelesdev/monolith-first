...
import ProductModelCatalog from "../store-catalog/repository/sequelize/ProductModel";
export default class SequelizeDBInit {
  static async execute(): Promise<void> {
    ...
    sequelize.addModels([ClientModel, AddressModel, ProductModel, ProductModelCatalog]);
